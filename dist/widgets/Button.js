...
exports.Button = (0, react_1.forwardRef)(function (props, ref) {
    ...
    var _o = props.as, as = _o === void 0 ? "l" : _o, disabled = props.disabled, button_disabled = props.button_disabled, restProps = __rest(props, ["as", "disabled", "button_disabled"]);
    ...
    return ((0, jsx_runtime_1.jsx)("button", __assign({ className: "button", ref: ref, type: (_m = restProps.type) !== null && _m !== void 0 ? _m : "button", disabled: button_disabled, css: globel_theme }, elementProps, { children: props.children })));
});
